 ReactiveFlix is an application written using the Java Spring 5 framework. It deomnstrates the use of reactive streams. Demostrasting the two kinds of publishers: Flux and Mono.
